...
export declare type TLoginData = void | false | string | object;
export declare type TRegisterData = void | false | string;
export declare type TForgotPasswordData = void | false | string;
export declare type TUpdatePasswordData = void | false | string;
/**
...
//# sourceMappingURL=IAuthContext.d.ts.map