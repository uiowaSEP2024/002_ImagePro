...
API_KEYS_DATA = [
    # Providers
    dict(email="noodlesco@gmail.com", key="VCm4-RBXxgtg__yqxf0SYGLHGn8", note="Noodles & Co Key"),
    dict(email="botimage@gmail.com", key="q-jAqPWCRGr2u6SeK6r6U0LBfJA", note="Bot Image Key"),
]
