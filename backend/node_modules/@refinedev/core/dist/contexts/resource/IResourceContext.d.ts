...
import { IResourceItem, ResourceMeta, ResourceProps } from "../../interfaces/bindings/resource";
...
declare type MetaProps<TExtends = {
    [key: string]: any;
}> = ResourceMeta & TExtends;
...
export interface IResourceComponentsProps<TCrudData = any, TMetaPropsExtends = {
    [key: string]: any;
...
//# sourceMappingURL=IResourceContext.d.ts.map